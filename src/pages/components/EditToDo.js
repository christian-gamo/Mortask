            ...
            <Modal show={openModal} size="md" onClose={() => setOpenModal(false)} popup>
                ...
                <Modal.Body>
                    ...
                    <form >
                        ...
                        <div>
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <input
                                    ...
                                    required
                                />
                                <label htmlFor="description" className="block my-5  mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
                        ...
                        <button type="submit" className="text-white mt-5 bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-purple-700 dark:hover:bg-purple-800 dark:focus:ring-purple-900 sm:w-auto">
                            Update new to-do
                        </button>
                    </form>
                </Modal.Body>
