    ...
    return (
        <>
            <div className="md:pt-1 pb-5 flex flex-col md:flex-row items-start md:items-center justify-between">
                <p tabIndex="0" className="flex-shrink-0 focus:outline-none text-lg md:text-2xl font-bold leading-normal text-gray-800 dark:text-white mb-2 md:mb-0">Mortis Daily Tasks</p>

                <div className="mt-2 md:flex space-x-2 md:space-x-2 flex-col md:flex-row md:items-center">
                    <button type="button" id="addTaskModalButton" data-modal-target="addTaskModal" data-modal-toggle="addTaskModal" className="px-4 py-2.5 text-sm font-medium text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 rounded-lg text-center dark:bg-purple-700 dark:hover:bg-purple-800 dark:focus:ring-purple-900 sm:w-auto">
