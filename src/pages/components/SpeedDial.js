    ...
    <>
      <div data-dial-init className="fixed end-6 bottom-6 group">
        ...
        >
          <button
            type="button"
            data-modal-target="shareToDoModal"
          ...
          <button
            type="button"
            data-modal-target="addToDoModal"
            data-modal-toggle="addToDoModal"
            data-tooltip-target="tooltip-newToDo"
            data-tooltip-placement="left"
          ...
          <div
            id="tooltip-newToDo"
            role="tooltip"
            className="absolute z-10 invisible inline-block min-w-[98px] px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700"
          >
            New To-Do
            <div className="tooltip-arrow" data-popper-arrow></div>
          </div>
        ...
        <button
          ...
          aria-expanded="false"
          className="flex items-center justify-center text-white bg-purple-700 rounded-full w-14 h-14 hover:bg-purple-800 dark:bg-purple-600 dark:hover:bg-purple-700 focus:ring-4 focus:ring-purple-300 focus:outline-none dark:focus:ring-purple-800"
        >
          <svg
