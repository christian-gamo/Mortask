      ...
      <div className="mt-2">
        <div className="flex items-center bg-gray-100 dark:bg-gray-700 rounded-lg p-4">
          ...
          <div className="ml-auto px-4 py-3 flex items-center justify-end">
            <span className={`hidden xl:inline-block bg-pink-100 text-pink-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-pink-900 dark:text-pink-300 ${completed ? 'no-line-through' : ''}`}>
              {item.todoItem_tag}
            </span>
            <span className={`hidden xl:inline-block bg-indigo-100 text-indigo-800 text-sm font-medium me-2 mr-10 px-2.5 py-0.5 rounded dark:bg-indigo-900 dark:text-indigo-300 ${completed ? 'no-line-through' : ''}`}>
