...
const ToDoItem = ({ isChecked, onToggleCompletion }) => {
    return (
        <>
            <div className="mt-2">
                <div className="flex items-center bg-gray-100 dark:bg-gray-700 rounded-lg p-4 hover:bg-gray-600">
                    ...
                    />
                    <div data-modal-target="viewTaskModal" data-modal-toggle="viewTaskModal">
                        <p
                    ...
                    <div className="ml-auto px-4 py-3 flex items-center justify-end">
                        ...
                        <div className="mx-3 pl-1 pt-1">
                            <button data-modal-target="editTaskModal" data-modal-toggle="editTaskModal">
                                <FontAwesomeIcon icon={faPenToSquare} className="w-6 h-5 text-gray-300 dark:text-gray-500" />
                            </button>
                        </div>
                        <div className="pt-1">
                            <button data-modal-target="deleteModal" data-modal-toggle="deleteModal">
                                <FontAwesomeIcon icon={faTrash} className="w-6 h-5   text-gray-300 dark:text-gray-500" />
                            </button>
                        </div>
                    </div>
                </div>
